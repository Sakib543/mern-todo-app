    ...
    <div className="min-h-screen bg-gradient-to-br from gray-50 to-blue-500 flex justify-center items-center p-4">
      <div className="bg-white p-8 rounded-xl shadow-xl w-full max-w-lg">
        <div>
          ...
          <form onSubmit={addTodo} className="flex items-center gap-2 p-2 border border-gray-200 rounded-lg shadow-md">
            <input
              type="text"
              value={newTodo}
              ...
              required
            />
            <button type="submit" className="text-white bg-blue-600 hover:bg-green-700 duration-300 shadow-md px-4 py-2 rounded-md font-medium cursor-pointer">
              Add Task
            </button>
          </form>
        </div>
